...
## Drawing the lower half

```{r}
pairs(wine[,2:12], upper.panel = NULL)
```

## Drawing the upper half
...
ggstatsplot::grouped_ggcorrmat(
  data = wine,
  cor.vars = 1:11,
  grouping.var = type,       # Replace 'type' with your column name (e.g., color, wine_type)
  type = "robust",           # Changes correlation to 'Winsorized Pearson'
  matrix.type = "lower",     # Flips the matrix to the lower-triangle view
  colors = c("#e66101", "white", "#5e3c99") # Optional: Adjusts colors to mimic a custom palette
)
```
...
## Creating interactive heatmap: Working with heatmaply
...
## Data transformation: Scaling Method
...
## Data transformation: Normalising Method

```{r}
heatmaply(normalize(wh_matrix[, -c(1, 2, 4, 5)]))
```

## Data transformation: Percentising Method
...
## Clustering algorithm: statistical approach
...
# Part 4: Visual Multivariate Analysis with Parallel Coordinates Plot
